        ...
        for (int b = 0; b < batchSize; b++)
        {
            ...
            for (int w = 0; w < width; w++)
            {
                for (int h = 0; h < height; h++)
                {
                    ...
                    if (!BlackAndWhite)
                    {
                        result[b, textures[b].height - h - 1, w, 0] = currentPixel.r/ 255f;
                        result[b, textures[b].height - h - 1, w, 1] = currentPixel.g/ 255f;
                        result[b, textures[b].height - h - 1, w, 2] = currentPixel.b/ 255f;
                    }
                    else
                    {
